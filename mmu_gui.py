...
COLORES_PROCESO = {
    "chrome":    "#4FC3F7", "chromium": "#4FC3F7", "google":  "#4FC3F7",
    "safari":    "#FF8A50",
    "firefox":   "#FF9500",
    "figma":     "#C084FC",
    "code":      "#4DB8FF", "cursor":   "#4DB8FF", "vscode":  "#4DB8FF",
    "node":      "#84CC60",
    "python":    "#FFD43B",
    "terminal":  "#3FB950", "iterm":    "#3FB950", "zsh":     "#3FB950",
    "blender":   "#FF8C42",
    "slack":     "#FF5C8A",
    "spotify":   "#1DB954",
    "zoom":      "#58A6FF",
...
PALETA = [
    "#58A6FF","#FF8A50","#C084FC","#3FB950",
    "#FF9500","#FF5C8A","#1DB954","#00CCD4",
    "#FF6B6B","#B97FFF","#FFD43B","#7289DA",
]
...
class Motor:
    ...
    def recolectar_procesos(self) -> List[dict]:
        ...
        ICONOS = {"chrome":"🌐","safari":"🧭","firefox":"🦊","figma":"🎨",
                  ...
                  "terminal":"🖥️","slack":"💬","spotify":"🎵","zoom":"📹",
                  "blender":"🔶","discord":"🎙️",
                  "minecraft":"⛏️","java":"☕","photoshop":"🎨",
                  "premiere":"🎬","aftereffects":"✨","unity":"🕹️",
...
/* CENTRO */
.center{display:flex;flex-direction:column;overflow-y:auto}
...
/* RAM GRID */
.ram-area{flex:0 0 auto;padding:12px 16px;min-height:180px}
